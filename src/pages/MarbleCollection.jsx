 ...
 * - Image paths assume files live under: /services/marble-collection/
 */
...
const sections = [
  {
    ...
    images: [
      "/services/marble-collection/slide-01.jpg",
      "/services/marble-collection/slide-02.jpg",
      "/services/marble-collection/slide-03.jpg",
    ],
  },
  {
    ...
    images: [
      "/services/marble-collection/slide-04.jpg",
      "/services/marble-collection/slide-05.jpg",
    ],
  },
  {
    title: "Vanity Tops",
    ...
    images: [
      "/services/marble-collection/slide-06.jpg",
      "/services/marble-collection/slide-07.jpg",
    ],
  },
  {
    ...
    images: [
      "/services/marble-collection/slide-08.jpg",
      "/services/marble-collection/slide-09.jpg",
    ],
  },
  {
    ...
    images: [
      "/services/marble-collection/slide-10.jpg",
      "/services/marble-collection/slide-11.jpg",
    ],
  },
];
  ...
  return (
    <div className="pb-20">
      ...
      <div className="container-xl mt-10 md:mt-14">
        <h1
          className="nav-serif font-semibold tracking-tight"
          style={{ color: red, fontSize: "clamp(32px, 5vw, 64px)" }}
        >
          Marble Collection For Sale
        </h1>
        <p className="mt-4 text-neutral-700 max-w-4xl text-lg">
      ...
      <div className="container-wide mt-8">
        <div className="rounded-2xl overflow-hidden">
          <img
            src="/services/marble-collection/banner.jpg"
            alt="Marble banner"
