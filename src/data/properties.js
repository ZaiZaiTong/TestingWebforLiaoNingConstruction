...
const data = {
  ...
  underConstruction: [
    { id: "tuasviewclose5", title: "No. 5 Tuas View Close", district: 14, image: img("tuasviewclose5"), link: "/properties/tuasviewclose5" },
    { id: "tuasviewclose11", title: "No. 11 Tuas View Close", district: 22, image: img("tuasviewclose11"), link: "/properties/tuasviewclose11" },
    { id: "farleighave65", title: "No. 65 Farleigh Ave", district: 19, image: img("farleighave65"), link: "/properties/farleighave65" },
  ],
  completed: [
    { id: "c-1", title: "No. 19 Tannery Lane", district: 13, image: img("placeholder"), link: "/properties/completed-a" },
    { id: "c-2", title: "No. 32 Jalan Jitong", district: 28, image: img("completed-b"), link: "/properties/completed-b" },
    { id: "chiselhurst63", title: "No. 63 Chiselhurst Grove", district: 19, image: img("chiselhurst63"), link: "/properties/chiselhurst63" },
    { id: "crowhurst52", title: "No. 52 Crowhurst Drive", district: 19, image: img("crowhurst52"), link: "/properties/crowhurst52" },
    ...
    { id: "geyland582", title: "No. 582 Geylang Road", district: 14, image: img("geyland582"), link: "/properties/geyland582" },
